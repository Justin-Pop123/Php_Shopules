                ...
                <div class="tile-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-link active" id="nav-pending-tab" data-toggle="tab" href="#nav-pending" role="tab" aria-controls="nav-pending" aria-selected="true"> Order </a>
                                ...
                                <table class="table table-hover table-bordered display">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $id = $confirm_order['id'];
                                            $order_date = $confirm_order['order_date'];
                                ...
                                <table class="table table-hover table-bordered display">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $id = $cancel_order['id'];
                                            $order_date = $cancel_order['order_date'];
